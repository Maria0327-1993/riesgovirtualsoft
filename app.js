...
function initApp() {
    ...
    navItems.forEach(item => {
        item.addEventListener('click', (e) => {
            ...
            if(item.textContent.includes('Documentación')) document.getElementById('view-docs').classList.add('active');
...
async function loadDashboardStats() {
    try {
        ...
        if(docList) {
            const docs = [
                { name: "Instructivo GGR Casino", file: "Instructivo de validaci�n de GGR Casino.pdf", date: "Hoy" },
                { name: "Pol�tica Retiros", file: "Pol�tica Procedimiento De Aprobaci�n De Retiros.pdf", date: "Ayer" }
            ];
